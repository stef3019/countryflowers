		...
		function renderContent()
		{
			...
			<div class="gsf-field-font-inner gsf-clearfix">
				...
				<div class="gsf-font-family">
					<div class="gsf-font-label"><?php esc_html_e('Font Family','spring-framework'); ?></div>
					<select data-field-control="" data-field-no-change="true" placeholder="<?php esc_attr_e('Select Font Family','spring-framework'); ?>"
				...
				<?php if (isset($this->_setting['font_size']) && $this->_setting['font_size']): ?>
					<div class="gsf-font-size">
						<div class="gsf-font-label"><?php esc_html_e('Font Size','spring-framework'); ?></div>
						...
						<input type="number" placeholder="<?php esc_attr_e('Font size','spring-framework'); ?>" step="<?php echo esc_attr($step); ?>"
				...
				<?php if (isset($this->_setting['font_weight']) && $this->_setting['font_weight']): ?>
					<div class="gsf-font-weight-style">
						...
						<div class="gsf-font-label"><?php esc_html_e('Font Weight & Style','spring-framework'); ?></div>
				...
				<?php if (isset($this->_setting['font_subsets']) && $this->_setting['font_subsets']): ?>
					<div class="gsf-font-subsets">
						<div class="gsf-font-label"><?php esc_html_e('Font Subsets','spring-framework'); ?></div>
