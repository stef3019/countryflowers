			...
			<div class="gsf-field-dimension-inner">
				<?php if ($is_width): ?>
					<div class="gsf-dimension-item">
						...
						<input data-field-control="" class="gsf-dimension" type="number" placeholder="<?php esc_html_e('Width','spring-framework'); ?>"
				...
				<?php if ($is_height): ?>
					<div class="gsf-dimension-item">
						...
						<input data-field-control="" class="gsf-dimension" type="number" placeholder="<?php esc_html_e('Height','spring-framework'); ?>"
