			...
			foreach ($custom_tax as $tax => $args) {
				...
				$default = array(
					...
					'labels'       => array(
						...
						'menu_name'                  => $label,
						'search_items'               => sprintf(esc_html__('Search %s', 'spring-framework'), $label),
						'popular_items'              => sprintf(esc_html__('Popular %s', 'spring-framework'), $label),
						'all_items'                  => sprintf(esc_html__('All %s', 'spring-framework'), $label),
						'parent_item'                => sprintf(esc_html__('Parent %s', 'spring-framework'), $singular_name),
						'parent_item_colon'          => sprintf(esc_html__('Parent %s:', 'spring-framework'), $singular_name),
						'edit_item'                  => sprintf(esc_html__('Edit %s', 'spring-framework'), $singular_name),
						'view_item'                  => sprintf(esc_html__('View %s', 'spring-framework'), $singular_name),
						'update_item'                => sprintf(esc_html__('Update %s', 'spring-framework'), $singular_name),
						'add_new_item'               => sprintf(esc_html__('Add New %s', 'spring-framework'), $singular_name),
						'new_item_name'              => sprintf(esc_html__('New %s New', 'spring-framework'), $singular_name),
						'separate_items_with_commas' => sprintf(esc_html__('Separate %s with commas', 'spring-framework'), strtolower($label)),
						'add_or_remove_items'        => sprintf(esc_html__('Add or remove %s', 'spring-framework'), strtolower($label)),
						'choose_from_most_used'      => sprintf(esc_html__('Choose from the most used %s', 'spring-framework'), strtolower($label)),
						'not_found'                  => sprintf(esc_html__('No %s found.', 'spring-framework'), strtolower($label)),
						'no_terms'                   => sprintf(esc_html__('No %s', 'spring-framework'), strtolower($label)),
						'items_list_navigation'      => sprintf(esc_html__('%s list navigation', 'spring-framework'), $label),
						'items_list'                 => sprintf(esc_html__('%s list', 'spring-framework'), $label),
					)
				);
