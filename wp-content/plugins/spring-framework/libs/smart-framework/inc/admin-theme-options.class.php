	...
	class GSF_Inc_Admin_Theme_Options
	{
		...
		public function adminEnqueueScripts() {
			...
			wp_localize_script(GSF()->assetsHandle('fields'), 'GSF_META_DATA', array(
				...
				'msgSavingOptions' => esc_html__('Saving Options...','spring-framework'),
				'msgResettingOptions' => esc_html__('Resetting Options...','spring-framework'),
				'msgResettingSection' => esc_html__('Resetting Section...','spring-framework'),
				'msgConfirmResetSection'   => esc_html__('Are you sure? Resetting will lose all custom values.', 'spring-framework'),
				'msgConfirmResetOptions' => esc_html__('Are you sure? Resetting will lose all custom values in this section.', 'spring-framework'),
				'msgResetOptionsDone' => esc_html__('Reset theme options done','spring-framework'),
				'msgResetOptionsError' => esc_html__('Reset theme options error','spring-framework'),
				'msgResetSectionDone' => esc_html__('Reset section done','spring-framework'),
				'msgResetSectionError' => esc_html__('Reset section error','spring-framework'),
				'msgConfirmImportData'               => esc_html__('Are you sure?  This will overwrite all existing option values, please proceed with caution!', 'spring-framework'),
				'msgImportDone'                      => esc_html__('Import option done', 'spring-framework'),
				'msgImportError'                     => esc_html__('Import option error', 'spring-framework'),
				'msgSaveWarning' => esc_html__('Settings have changed, you should save them!','spring-framework'),
				'msgSaveSuccess' => esc_html__('Data saved successfully!','spring-framework'),
				'msgConfirmDeletePreset'   => esc_html__('Are you sure? The current preset will be deleted!', 'spring-framework'),
				'msgDeletePresetDone' => esc_html__('Reset theme options done','spring-framework'),
				'msgDeletePresetError' => esc_html__('Reset theme options error','spring-framework'),
				'msgDeletingPreset' => esc_html__('Deleting Section...','spring-framework'),
				'msgPreventChangeData' => esc_html__('Changes you made may not be saved. Do you want change options?','spring-framework')
			));
		}
			...
			<div class="gsf-theme-options-backup-popup-wrapper mfp-with-anim">
				<div class="gsf-theme-options-backup-popup">
					<div class="gsf-theme-options-backup-header gsf-clearfix">
						<h4><?php esc_html_e('Import/Export Options','spring-framework'); ?></h4>
					</div>
					<div class="gsf-theme-options-backup-content">
						<section>
							<h5><?php esc_html_e('Import Options','spring-framework'); ?></h5>
							<div class="gsf-theme-options-backup-import">
								<textarea></textarea>
								<button type="button" class="button"
								        data-import-text="<?php esc_attr_e('Import','spring-framework'); ?>"
								        data-importing-text="<?php esc_attr_e('Importing...','spring-framework'); ?>"><?php esc_html_e('Import','spring-framework'); ?></button>
								<span class=""><?php esc_html_e('WARNING! This will overwrite all existing option values, please proceed with caution!','spring-framework'); ?></span>
							</div>
						</section>
						<section>
							<h5><?php esc_html_e('Export Options','spring-framework'); ?></h5>
							<div class="gsf-theme-options-backup-export">
								<textarea readonly><?php echo base64_encode(json_encode($options)); ?></textarea>
								<button type="button" class="button"><?php esc_html_e('Download Data File','spring-framework'); ?></button>
							</div>
						</section>
					</div>
				</div>
		...
		public function saveOptions() {
			...
			wp_send_json_success(esc_html__('Save options Done','spring-framework'));
		}
