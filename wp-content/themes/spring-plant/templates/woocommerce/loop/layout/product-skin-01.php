	...
	<div class="<?php echo esc_attr($post_inner_class); ?>">
		...
		<div class="product-info">
			<div class="product-actions">
				<?php
				/**
				 * @hooked shop_loop_list_add_to_cart - 5
				 */
				do_action('spring_plant_product_actions');
				?>
				<div class="product-action-inner">
					<?php
					remove_action('spring_plant_woocommerce_product_actions', array(Spring_Plant()->templates(), 'shop_loop_add_to_cart'), 5);
