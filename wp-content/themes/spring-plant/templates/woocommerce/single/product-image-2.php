				...
				foreach ($product_images as $key => $value) {
					...
					if (!empty($variation_id)) { ?>
						<a href="<?php echo esc_url($image_link); ?>" class="woocommerce-thumbnail-image"
						   ...
						   data-index="<?php echo esc_attr($index); ?>" data-magnific="true" data-gallery-id="<?php echo esc_attr($gallery_id) ?>"
                           data-magnific-options='<?php echo json_encode(array('galleryId' => $gallery_id)); ?>'><?php echo sprintf('%s', $image); ?></a>
					<?php } else { ?>
						<a href="<?php echo esc_url($image_link); ?>" class="woocommerce-thumbnail-image" data-magnific="true"
                           data-magnific-options='<?php echo json_encode(array('galleryId' => $gallery_id)); ?>' data-gallery-id="<?php echo esc_attr($gallery_id) ?>"
						   title="<?php echo esc_attr($image_caption); ?>" data-index="<?php echo esc_attr($index); ?>"><?php echo sprintf('%s', $image); ?></a>
					<?php }
					echo '</div>';
				}
				?>
