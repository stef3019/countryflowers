...
if (!class_exists('Spring_Plant_Inc_Custom_Css')) {
	class Spring_Plant_Inc_Custom_Css
	{
        ...
        public function init_custom_css() {
            echo '<style id="spring-plant-custom-css"></style>';
        }

        public function render_custom_css() {
            echo sprintf('<script>jQuery("style#spring-plant-custom-css").append("%s");</script>',$this->getCss());
        }
	}
}