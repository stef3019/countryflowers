<?php
if (!class_exists('Spring_Plant_Inc_Term_Meta')) {
    class Spring_Plant_Inc_Term_Meta {
        ...
        public function get_product_taxonomy_color($id = ''){ return $this->getMetaValue('gsf_spring_product_taxonomy_color', $id); }
        ...
        public function &getDefault() {
            $default = array (
                ...
                'gsf_spring_product_taxonomy_color' => '#000'
            );
            return $default;
        }
    }
